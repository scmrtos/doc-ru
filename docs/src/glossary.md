...
Embedded C++, является подмножеством С++. Не поддерживает пространства имён, шаблоны, множественное наследование, RTTI, обработку исключений, новый синтаксис явного преобразования типов.
...
Программные объекты, расширяющие функциональность операционной системы, но не в входящие в основой5 состав ОС. Примером расширения может служить профилировщик работы процессов системы.
