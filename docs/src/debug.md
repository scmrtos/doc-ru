...
Для использования профилировщика в пользовательском проекте необходимо определить функцию измерения времени и подключить профилировщик к проекту. Подробнее об этом см. [пример в приложении Профилировка процессов](profiler.md). 
